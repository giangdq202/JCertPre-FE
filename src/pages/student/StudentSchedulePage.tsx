...
// Livestream interface for enrolled courses
...
const StudentSchedulePage: React.FC = () => {
            ...
            <div className="flex flex-col gap-1">
              {eventsForDate.map((livestream, index) => (
                <div
                  ...
                  className="bg-gradient-to-r from-emerald-500 to-teal-600 text-white text-xs px-2 py-1 rounded-full shadow-lg transform hover:scale-105 transition-all duration-200 cursor-pointer border border-white"
                  style={{
                    maxWidth: '120px',
                    fontSize: '10px',
                    lineHeight: '1.2',
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 flex flex-col lg:flex-row font-inter">
      <style>
        {`
              ...
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  ...
                  <p className="text-blue-100 text-lg font-medium">
                    Theo dõi lịch trình học tập và livestream
                  </p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
                <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/20">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-2xl font-bold">{livestreams.length > 0 ? livestreams.filter(l => l.userRole === 'STUDENT').length : 0}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/20">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-blue-100 text-sm font-medium">Livestream sắp tới</p>
                      <p className="text-2xl font-bold">{livestreams.filter(l => l.status === 'SCHEDULED').length}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/20">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-blue-100 text-sm font-medium">Đang diễn ra</p>
                      <p className="text-2xl font-bold">{livestreams.filter(l => l.status === 'LIVE').length}</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden">
            <div className="bg-gradient-to-r from-gray-50 to-gray-100 px-8 py-6 border-b border-gray-200">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-gray-800">Lịch học tập</h2>
              ...
              {isLoadingLivestreams ? (
                <div className="flex justify-center items-center h-64">
                  <div className="text-center">
                    <Spin size="large" />
                    <p className="mt-4 text-gray-600 font-medium">Đang tải lịch học...</p>
                  </div>
                </div>
              ) : (
                <Calendar
          ...
          <Modal
            title={
              <div className="flex items-center gap-3">
                ...
                <span className="text-xl font-bold text-gray-800">Chi tiết buổi học</span>
              </div>
            }
            open={isModalOpen}
            ...
            {selectedEvents.length > 0 ? (
                  ...
                  >
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        {livestream.startsWithin15Minutes && !livestream.canJoin && (
                        ...
                        <Button
                          ...
                          onClick={() => livestream.canJoin && handleJoinLivestream(livestream)}
                          disabled={!livestream.canJoin || livestream.status === 'COMPLETED'}
                        >
                          {livestream.status === 'COMPLETED' 
                            ? 'Đã kết thúc' 
                            : livestream.canJoin 
              ...
              <div className="text-center py-8">
                ...
                <p className="text-gray-600 font-medium text-lg">
                  Không có livestream nào trong ngày này.
                </p>
                <p className="text-gray-500 mt-2">
                  Hãy chọn ngày khác để xem lịch học tập.
                </p>
              </div>
            )}
          </Modal>
