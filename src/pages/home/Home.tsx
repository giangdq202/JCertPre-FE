              ...
              {idx === 2 && (
                <div className="absolute bottom-6 left-6 z-20 text-left text-[#1F1F1F] max-w-sm bg-white/85 px-5 py-4 rounded-xl shadow-lg backdrop-blur-md border border-gray-200">
                  ...
                  <div className="flex space-x-3">
                    <Link
                      to="/register"
                      className="px-4 py-1.5 bg-red-600 hover:bg-red-700 text-white rounded-full text-xs font-semibold shadow-md transition"
                    >
                      Đăng ký
                    </Link>
                    <Link
                      to="/login"
                      className="px-4 py-1.5 border border-gray-500 text-gray-800 hover:bg-gray-800 hover:text-white rounded-full text-xs font-semibold transition"
                    >
                      Đăng nhập
                    </Link>
                  </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="group bg-[#F9F9F9] text-gray-800 rounded-xl shadow-md overflow-hidden hover:shadow-xl transition duration-300 border border-gray-200 hover:border-red-300">
            ...
            <div className="p-6">
              ...
              <div className="flex justify-center">
                <button className="border border-red-600 px-5 py-2 text-sm rounded hover:bg-red-600 hover:text-white transition">
                  XEM THÊM
                </button>
              </div>
            </div>
          ...
          <div className="group bg-[#FDF8EE] text-gray-800 rounded-xl shadow-md overflow-hidden hover:shadow-xl transition duration-300 border border-yellow-200 hover:border-yellow-400">
            ...
            <div className="p-6">
              ...
              <div className="flex justify-center">
                <button className="border border-yellow-600 px-5 py-2 text-sm rounded hover:bg-yellow-600 hover:text-white transition">
                  XEM THÊM
                </button>
              </div>
            </div>
          ...
          <div className="group bg-[#EFF6FC] text-gray-800 rounded-xl shadow-md overflow-hidden hover:shadow-xl transition duration-300 border border-blue-200 hover:border-blue-400">
            ...
            <div className="p-6">
              ...
              <div className="flex justify-center">
                <button className="border border-blue-600 px-5 py-2 text-sm rounded hover:bg-blue-600 hover:text-white transition">
                  XEM THÊM
                </button>
              </div>
            </div>
